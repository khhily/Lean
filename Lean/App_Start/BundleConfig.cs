...
namespace Lean
{
    public class BundleConfig
    {
        ...
        public static readonly string SiteCss = "~/Content/css";
        public static readonly string JqueryUICss = "~/Content/themes/base/css";
        public static readonly string DateTimePicker = "~/Scripts/datetimepicker";
        public static readonly string DateTimePickerCss = "~/Content/datetimepicker";
